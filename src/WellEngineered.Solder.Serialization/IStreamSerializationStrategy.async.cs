...
namespace WellEngineered.Solder.Serialization
{
	...
	public partial interface IStreamSerializationStrategy
	{
		...
		ValueTask<object> DeserializeObjectFromStreamAsync(Stream stream, Type targetType);
		...
		/// <param name="stream"> The readable stream to deserialize. </param>
		/// <returns> An object of the target type or null. </returns>
		ValueTask<TObject> DeserializeObjectFromStreamAsync<TObject>(Stream stream);
		...
		ValueTask SerializeObjectToStreamAsync(Stream stream, Type targetType, object obj);
		...
		/// <param name="stream"> The writable stream to serialize. </param>
		/// <param name="obj"> The object graph to serialize. </param>
		ValueTask SerializeObjectToStreamAsync<TObject>(Stream stream, TObject obj);
