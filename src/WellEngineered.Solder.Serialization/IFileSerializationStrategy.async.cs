...
namespace WellEngineered.Solder.Serialization
{
	...
	/// </summary>
	public partial interface IFileSerializationStrategy
	{
		...
		ValueTask<object> DeserializeObjectFromFileAsync(string inputFilePath, Type targetType, CancellationToken cancellationToken = default);
		...
		/// <param name="inputFilePath"> The input file path to deserialize. </param>
		/// <returns> An object of the target type or null. </returns>
		ValueTask<TObject> DeserializeObjectFromFileAsync<TObject>(string inputFilePath, CancellationToken cancellationToken = default);
		...
		ValueTask SerializeObjectToFileAsync<TObject>(string outputFilePath, TObject obj, CancellationToken cancellationToken = default);
		...
		/// <param name="obj"> The object graph to serialize. </param>
		ValueTask SerializeObjectToFileAsync(string outputFilePath, Type targetType, object obj, CancellationToken cancellationToken = default);
