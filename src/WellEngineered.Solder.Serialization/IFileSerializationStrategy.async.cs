...
namespace WellEngineered.Solder.Serialization
{
	...
	public partial interface IFileSerializationStrategy
	{
		...
		ValueTask<object> DeserializeObjectFromFileAsync(string inputFilePath, Type targetType);
		...
		/// <param name="inputFilePath"> The input file path to deserialize. </param>
		/// <returns> An object of the target type or null. </returns>
		ValueTask<TObject> DeserializeObjectFromFileAsync<TObject>(string inputFilePath);
		...
		ValueTask SerializeObjectToFileAsync<TObject>(string outputFilePath, TObject obj);
		...
		/// <param name="obj"> The object graph to serialize. </param>
		ValueTask SerializeObjectToFileAsync(string outputFilePath, Type targetType, object obj);
