...
namespace WellEngineered.Solder.Serialization
{
	...
	public partial interface ICharArraySerializationStrategy
	{
		...
		ValueTask<object> DeserializeObjectFromCharArrayAsync(char[] value, Type targetType);
		...
		/// <param name="value"> The char array value to deserialize. </param>
		/// <returns> An object of the target type or null. </returns>
		ValueTask<TObject> DeserializeObjectFromCharArrayAsync<TObject>(char[] value);
		...
		ValueTask<char[]> SerializeObjectToCharArrayAsync(Type targetType, object obj);
		...
		/// <param name="obj"> The object graph to serialize. </param>
		/// <returns> A char array representation of the object graph. </returns>
		ValueTask<char[]> SerializeObjectToCharArrayAsync<TObject>(TObject obj);
