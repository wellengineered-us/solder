...
namespace WellEngineered.Solder.Serialization
{
	...
	/// </summary>
	public partial interface IStreamSerializationStrategy : ISerializationStrategy
	{
		...
		object DeserializeObjectFromStream(Stream stream, Type targetType);
		...
		/// <param name="stream"> The readable stream to deserialize. </param>
		/// <returns> An object of the target type or null. </returns>
		TObject DeserializeObjectFromStream<TObject>(Stream stream);
		...
		void SerializeObjectToStream(Stream stream, Type targetType, object obj);
		...
		/// <param name="stream"> The writable stream to serialize. </param>
		/// <param name="obj"> The object graph to serialize. </param>
		void SerializeObjectToStream<TObject>(Stream stream, TObject obj);
