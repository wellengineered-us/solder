...
{
	/// <summary>
	/// Marks a property of an XML configuration object as being mapped to/from an XML attribute.
	/// </summary>
	[AttributeUsage(AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
	public sealed class XyzlAttributeMappingAttribute : Attribute
	{
		...
		/// </summary>
		public XyzlAttributeMappingAttribute()
		{
		}
