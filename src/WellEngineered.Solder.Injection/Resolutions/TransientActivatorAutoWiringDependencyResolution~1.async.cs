...
namespace WellEngineered.Solder.Injection.Resolutions
{
	...
	public sealed partial class TransientActivatorAutoWiringDependencyResolution<TResolution> : DependencyResolution<TResolution>
	{
		...
		protected override async ValueTask<TResolution> CoreResolveAsync(IDependencyManager dependencyManager, string selectorKey, CancellationToken cancellationToken = default)
		{
			...
			return await TransientActivatorAutoWiringDependencyResolution.AutoWireResolveAsync<TResolution>(typeof(TResolution), dependencyManager, selectorKey, cancellationToken);
		}
